...
parameter int unsigned L15_BE_WIDTH       = `L15_BYTE_MASK_WIDTH;
parameter int unsigned L15_TID_WIDTH      = `L15_THREADID_WIDTH;
parameter int unsigned L15_SET_ASSOC      = `CONFIG_L15_ASSOCIATIVITY;
parameter int unsigned L15_WAY_WIDTH      = $clog2(L15_SET_ASSOC);
parameter int unsigned L15_TLB_CSM_WIDTH  = `TLB_CSM_WIDTH;
