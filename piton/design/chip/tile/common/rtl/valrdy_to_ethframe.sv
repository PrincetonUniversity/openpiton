...
// we don't stuck input Eth frames since they could be retransmitted infinitely, so flushing them during reset to avoid filling-up the bridge pipeline released from reset earlier
