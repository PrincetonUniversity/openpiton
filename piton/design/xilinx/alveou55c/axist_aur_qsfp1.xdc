...
# set aur_clk_units [get_cells -of_objects [get_nets -of_objects [get_pins -hierarchical eth_cmac/gt_txusrclk2]]]
...
# set aur_clk [get_clocks -of_objects [get_pins -hierarchical eth_cmac/gt_txusrclk2 ]]
