...
if { [file exists $PROTOSYN_RUNTIME_DESIGN_PATH/f1/cl_clocks_aws.xdc] } {
        puts "Deleting old CL clocks constraints file since it will be replaced.";
        file delete -force $PROTOSYN_RUNTIME_DESIGN_PATH/f1/cl_clocks_aws.xdc
}
set clocks_file [open "$PROTOSYN_RUNTIME_DESIGN_PATH/f1/cl_clocks_aws.xdc" w]
