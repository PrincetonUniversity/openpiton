...
* 
* OpenSPARC T1 Processor File: L2_MISS_COUNTER_DMM_test.s
...
#define	 L2_MISS_COUNTER_BASE_VA_HI	0xab
#define	 L2_ACCESS_COUNTER_BASE_VA_HI	0xaa
#define	 L2_CONFIG_REG_BASE_VA_HI	0xa9
...
#define	 L2_MISS_COUNTER_VA_INCR		64
...
active_thread:	
	...
	ba	TEST_L2_MISS_COUNTER
	nop

	.align	1024
!
TEST_L2_MISS_COUNTER:	
	or	%g0,L2_MISS_COUNTER_BASE_VA_HI,%g1
	sllx	%g1,L2_VA_HI_SAMT,%g1		! build address of the L2 Control Reg
    mov 0x0,  %l0
	stx	%l0,[%g1]

	or	%g0,L2_ACCESS_COUNTER_BASE_VA_HI,%g5
	sllx	%g5,L2_VA_HI_SAMT,%g5		! build address of the L2 Control Reg
    mov 0x0,  %l0
	stx	%l0,[%g5]


	or	%g0,L2_CONFIG_REG_BASE_VA_HI,%g2
	sllx	%g2,L2_VA_HI_SAMT,%g2		! build address of the L2 Control Reg
    mov 0xc,  %l0
	stx	%l0,[%g2]

    setx DATA_dw00, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw01, %g3, %g4
    ldx [%g4], %g3 
    
    setx DATA_dw02, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw03, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw04, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw05, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw06, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw07, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw08, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw09, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw0a, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw0b, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw0c, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw0d, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw0e, %g3, %g4
    ldx [%g4], %g3 

    setx DATA_dw0f, %g3, %g4
    ldx [%g4], %g3 
