...
th_main_1:
	...
	setx	0xb300000000, %l0, %o0
	stx	 %l0, [%o0]

	setx	0xb300800000, %l0, %o0
	stx	 %l0, [%o0]

	setx	0xb301000000, %l0, %o0
	stx	 %l0, [%o0]

	setx	0xb301800000, %l0, %o0
	stx	 %l0, [%o0]

	setx	0xb302000000, %l0, %o0
	stx	 %l0, [%o0]

	setx	0xb302800000, %l0, %o0
	stx	 %l0, [%o0]

	setx	0xb303000000, %l0, %o0
	stx	 %l0, [%o0]

	setx	0xb303800000, %l0, %o0
	stx	 %l0, [%o0]
